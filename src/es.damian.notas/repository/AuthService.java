...
public class AuthService {
    ...
    public boolean registrar(String email, String password) {
        ...
        try {
            ...
            System.err.println("Error critico en el registro: " + e.getMessage());
            return false;
        }
    }
    ...
    public Usuario login(String email, String password) {
        try {
            ...
            for (Usuario u : usuarios) {
                if (u.getEmail().equalsIgnoreCase(email) && u.getPassword().equals(password)) {
                    System.out.println("Sesion iniciada para: " + email);
                    return u;
                }
            }
        } catch (IOException e) {
        ...
        System.out.println("Error: Email o contrasena incorrectos.");
        return null;
    }
